...
fn process_result(solved_sudoku: &[[SudokuCell; 16]; 16]) -> [[u8; 16]; 16] {
    // let mut v: [[SudokuCell; 16]; 16] = [[SudokuCell::AssignedValue(0); 16]; 16];
    let mut v: [[u8; 16]; 16] = [[0; 16]; 16];
