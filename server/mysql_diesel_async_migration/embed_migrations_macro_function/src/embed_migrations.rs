...
pub fn expand(path: String) -> proc_macro2::TokenStream {
    ...
    quote! {
        mysql_diesel_async_migration::EmbeddedMigrations{migrations: &[#(#embeded_migrations,)*], setup_attempted: std::sync::atomic::AtomicU8::new(0), }
    }
}
...
fn migration_literal_from_path(path: &Path) -> proc_macro2::TokenStream {
    ...
    quote!(mysql_diesel_async_migration::EmbeddedMigration {
